...
type Documents = {
  ...
  "\n  query SatelliteActivity($id: ID!) {\n    Satellite(id: $id) {\n      id\n      Contacts {\n        id\n        date\n        type\n        GroundStation {\n          id\n          name\n          status\n          coordinates\n        }\n        Payload {\n          id\n          name\n        }\n        Employee {\n          id\n          name\n        }\n      }\n      Reports {\n        id\n        title\n        type\n        date\n        content\n        Employee {\n          id\n          name\n          role\n        }\n        Comments {\n          id\n          date\n          content\n          Employee {\n            id\n            name\n            role\n          }\n        }\n      }\n    }\n  }\n": typeof types.SatelliteActivityDocument;
  '\n  query MapSatellites($perPage: Int!, $page: Int!) {\n    allSatellites(perPage: $perPage, page: $page, sortField: "name", sortOrder: "asc") {\n      id\n      name\n      status\n      altitude\n      coordinates\n      tle\n    }\n  }\n': typeof types.MapSatellitesDocument;
  ...
  "\n  query GroundStationDetail($id: ID!) {\n    GroundStation(id: $id) {\n      id\n      name\n      status\n      network\n      coordinates\n      Contacts {\n        id\n        date\n        type\n        Satellite {\n          id\n          name\n          status\n          tle\n        }\n        Payload {\n          id\n          name\n        }\n        Employee {\n          id\n          name\n        }\n      }\n      Reports {\n        id\n        title\n        type\n        date\n        content\n        Employee {\n          id\n          name\n          role\n        }\n        Comments {\n          id\n          date\n          content\n          Employee {\n            id\n            name\n            role\n          }\n        }\n      }\n    }\n  }\n": typeof types.GroundStationDetailDocument;
  ...
  "\n  fragment NewComment on Comment {\n    id\n    date\n    content\n    Employee {\n      id\n      name\n      role\n    }\n  }\n": typeof types.NewCommentFragmentDoc;
};
const documents: Documents = {
  ...
  "\n  query SatelliteActivity($id: ID!) {\n    Satellite(id: $id) {\n      id\n      Contacts {\n        id\n        date\n        type\n        GroundStation {\n          id\n          name\n          status\n          coordinates\n        }\n        Payload {\n          id\n          name\n        }\n        Employee {\n          id\n          name\n        }\n      }\n      Reports {\n        id\n        title\n        type\n        date\n        content\n        Employee {\n          id\n          name\n          role\n        }\n        Comments {\n          id\n          date\n          content\n          Employee {\n            id\n            name\n            role\n          }\n        }\n      }\n    }\n  }\n":
    types.SatelliteActivityDocument,
  '\n  query MapSatellites($perPage: Int!, $page: Int!) {\n    allSatellites(perPage: $perPage, page: $page, sortField: "name", sortOrder: "asc") {\n      id\n      name\n      status\n      altitude\n      coordinates\n      tle\n    }\n  }\n':
    types.MapSatellitesDocument,
  '\n  query GroundStations($perPage: Int!, $page: Int!) {\n    allGroundStations(perPage: $perPage, page: $page, sortField: "name", sortOrder: "asc") {\n      id\n      name\n      status\n      network\n      coordinates\n    }\n  }\n':
    types.GroundStationsDocument,
  "\n  query GroundStationDetail($id: ID!) {\n    GroundStation(id: $id) {\n      id\n      name\n      status\n      network\n      coordinates\n      Contacts {\n        id\n        date\n        type\n        Satellite {\n          id\n          name\n          status\n          tle\n        }\n        Payload {\n          id\n          name\n        }\n        Employee {\n          id\n          name\n        }\n      }\n      Reports {\n        id\n        title\n        type\n        date\n        content\n        Employee {\n          id\n          name\n          role\n        }\n        Comments {\n          id\n          date\n          content\n          Employee {\n            id\n            name\n            role\n          }\n        }\n      }\n    }\n  }\n":
    types.GroundStationDetailDocument,
  '\n  query Contacts($perPage: Int!, $page: Int!) {\n    allContacts(perPage: $perPage, page: $page, sortField: "date", sortOrder: "desc") {\n      id\n      date\n      type\n      executionScript\n      configuration\n      Satellite {\n        id\n        name\n        status\n        tle\n      }\n      GroundStation {\n        id\n        name\n        status\n        coordinates\n      }\n      Payload {\n        id\n        name\n        category\n        Customer {\n          id\n          name\n        }\n      }\n      Employee {\n        id\n        name\n        role\n      }\n    }\n  }\n':
